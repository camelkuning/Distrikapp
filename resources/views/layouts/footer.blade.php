    ...
    <div class="container">
      <div class="row g-4">
        <div class="col-md-6 col-lg-3 mb-3 mb-md-0">
          <div class="widget">
            <h3 class="widget-heading">Bintuni Timur</h3>
            <p class="mb-4">
            Kunjungi Galeri Kami Untuk Melihat Keseruan Kami
            </p>
            <p class="mb-0">
              <a href="/galeri" class="btn-learn-more">Galeri</a>
            </p>
          </div>
        </div>
      ...
      <div class="copyright d-flex flex-column flex-md-row align-items-center justify-content-md-between">
        <p>© <span>Copyright</span> <strong class="px-1 sitename">Bintuni Timur.</strong> <span>All Right Reserved</span></p>
        <div class="credits">
