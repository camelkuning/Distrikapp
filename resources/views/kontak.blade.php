                    ...
                    <div class="row gy-5 gx-lg-5">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="info">
                                ...
                                <p>Kirimkan Kritik & Saran anda kepada kami</p>
                        ...
                        <div class="col-lg-8">
                            ...
                            <form action="{{ route('contact') }}" method="post" role="form" class="php-email-form">
                                ...
                                <div class="form-group mt-3">
                                    <input type="text" class="form-control" name="subject" id="subject" placeholder="Subjek (Laporan atau Kritik & Saran)" required="">
                                </div>
                                <div class="form-group mt-3">
