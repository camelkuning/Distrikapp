...
const navbar = document.querySelector('#header'); // Ensure you have the correct selector for your navbar

window.onscroll = () => {
    // Check if the window has been scrolled more than 100 pixels
    if (window.scrollY > 100) {
        navbar.classList.add('scrolled-navbar'); // Add class to navbar
    } else {
        navbar.classList.remove('scrolled-navbar'); // Remove class from navbar
    }
